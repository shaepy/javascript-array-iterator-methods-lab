...
// OG inventors is an array. inventors[0] = object
...
sortedByBirthYear = inventors.map((inventor) => inventor)
...
inventorNamedAda = inventors.find((inventor) => inventor.first === 'Ada' ? inventor : null)
